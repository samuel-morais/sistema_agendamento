...
class PacienteAdmin(admin.ModelAdmin):
    list_display = (
        ...
        'data_nascimento', 'criado_em', 'atualizado_em'
    )
...
class ConsultaAdmin(admin.ModelAdmin):
    list_display = (
        'paciente', 'medico', 'formatted_data_hora',
        'duracao_minutos', 'status', 'confirmada',
        'usa_convenio', 'get_convenio',
...
class ExameAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'nome', 'prontuario',
        'observado_por', 'criado_em', 'atualizado_em'
    )
    search_fields = (
        'nome',
        'prontuario__paciente__nome',
        'observado_por__username'
    )
    list_filter = ('criado_em', 'atualizado_em')
